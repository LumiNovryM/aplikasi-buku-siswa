...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      {{-- <li class="nav-item d-none d-sm-inline-block">
        <a href="/kasus" class="nav-link">Data Kasus</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/pelanggaran" class="nav-link">Data Pelanggaran</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/category" class="nav-link">Category Pelanggaran</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/siswa" class="nav-link">Data Siswa</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/siswa" class="nav-link">Data Guru</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/siswa" class="nav-link">Data Kelas</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/siswa" class="nav-link">Data Jurusan</a>
      </li> --}}
    </ul>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="{{ asset('template/dist/img/user1-128x128.jp') }}g" alt="User Avatar" class="img-size-50 mr-3 img-circle">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="/kasus" class="brand-link">
      <img src="{{ asset('template/dist/img/AdminLTELogo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">App Buku Siswa</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="/kasus" class="d-block">Admin</a>
        </div>
      </div>
