...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Tambah Pelanggaran</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
            ...
            <div class="card-body">
                <form method="POST" action="/insertpelanggaran">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" autocomplete="off" name="nama_pelanggaran" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                      <label for="exampleInputPassword1" class="form-label">Tindak Lanjut</label>
                      <input type="text" autocomplete="off" name="tindak_lanjut" class="form-control" id="exampleInputPassword1">
                    </div>
                    <div class="mb-3">
                      ...
                      <select class="form-select" name="id_category" aria-label="Default select example">
                        <option selected>Pilih Jenis Category</option>
                        @foreach ($cat as $ct)
